...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=7, fig.align='center'----
...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=8, fig.height=20, fig.align='center'----
NDays <- 7
par(mfrow=c(NDays, 1))
...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=14, fig.align='center'----
par(mfrow=c(2, 1))
# Simulate data
...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=6, fig.height=6, fig.align='center'----
par(mfrow=c(1, 1))
iDay <- 2
...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=8, fig.height=8, fig.align='center'----
...
## ---- warning=FALSE, message=FALSE, cache=TRUE, fig.width=11, fig.height=11, fig.align='center'----
# Set any connection less than the mode to zero and plot network
