...
# See:      https://github.com/scikit-learn/scikit-learn/issues/6450
#----------------------------------------------------------------------------------------------------------------------#
...
#----------------------------------------------------------------------------------------------------------------------#
def tsne(X = np.array([]), no_dims = 2, initial_dims = 50, perplexity = 30.0, seed=0):
	...
	eta = 500
	min_gain = 0.01 
	np.random.seed(seed) # add seed to reproduce result
